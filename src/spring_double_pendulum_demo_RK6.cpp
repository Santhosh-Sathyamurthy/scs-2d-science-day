...
SpringDoublePendulumDemo_RK6::SpringDoublePendulumDemo_RK6() {
    setName("Double Pendulum Demo (RK6)");
...
void SpringDoublePendulumDemo_RK6::initialize() {
    clear();
...
void SpringDoublePendulumDemo_RK6::process(float dt) {
...
void SpringDoublePendulumDemo_RK6::render() {
    m_app->drawGrid();
